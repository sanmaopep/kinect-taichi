...
namespace KinectCSharp.core
{
    ...
    class FeaturePainter
    {
        ...
        /// </summary>
        private const float RenderWidth = 320.0f;

        /// <summary>
        /// Height of our output drawing
        /// </summary>
        private const float RenderHeight = 240.0f;
        ...
        public FeaturePainter(KinectControl kinectControl)
        {
        ...
        public void paint(Feature feature)
        {
            using (DrawingContext dc = this.drawingGroup.Open())
            {
                ...
                if (feature.ok)
                {
                    this.DrawBonesAndJoints(feature.skeleton, dc);
                }
            }
